...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        rospy.init_node('u', anonymous=True)
    ...
    def send_goal_x(self, number):
        ...
        self.x_goal.target_pose.pose.position.x    = px[number]
        self.x_goal.target_pose.pose.position.y    = py[number]
        self.x_goal.target_pose.pose.position.z    = pz[number]
        self.x_goal.target_pose.pose.orientation.z = oz[number] 
        self.x_goal.target_pose.pose.orientation.w = ow[number]
    ...
    def send_2nd(self):
        ...
        self.move_g2.target_pose.pose.position.y =  1.5
    ...
    def send_3rd(self):
        ...
        self.move_g3.target_pose.pose.position.x = -1.0
        self.move_g3.target_pose.pose.position.y = 1.7
        self.move_g3.target_pose.pose.position.z = 0.0
        self.move_g3.target_pose.pose.orientation.z = -1.0
        self.move_g3.target_pose.pose.orientation.w = 0.3
    ...
    def send_4th(self):
        ...
        self.move_g4.target_pose.pose.position.y = 0.2
        self.move_g4.target_pose.pose.position.z = 0.0
        self.move_g4.target_pose.pose.orientation.z = -0.6
    ...
    def send_5th(self):
        ...
        self.move_g5.target_pose.pose.position.x = -2
        self.move_g5.target_pose.pose.position.y = -0.5
        self.move_g5.target_pose.pose.position.z = 0.0
        self.move_g5.target_pose.pose.orientation.z = -5
        self.move_g5.target_pose.pose.orientation.w = 1
